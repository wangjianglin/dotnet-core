...
namespace Lin.Core.Web.Json
{
    public abstract class JsonValue : IEnumerable
    {
        ...
        public static JsonValue Load(Stream stream)
        {
            ...
            if (!stream.CanSeek)
            {
                stream2 = new Lin.Core.Web.Json.JavaScriptDeserializer.BufferedStreamReader(stream);
            }
            Encoding encoding = Lin.Core.Web.Json.JavaScriptDeserializer.DetectEncoding(stream2.ReadByte(), stream2.ReadByte());
            stream2.Position = 0L;
        ...
        public static JsonValue Parse(string jsonString)
        {
            ...
            Lin.Core.Web.Json.JavaScriptObjectDeserializer deserializer = new Lin.Core.Web.Json.JavaScriptObjectDeserializer(jsonString, false);
